        ...
        <div className="container px-4 md:px-6 grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-5">
          ...
          <div>
            ...
            <div className="text-xs mt-2 space-y-1">
              <div>
                <Link href="/#features" className="hover:text-[#2aa160] transition-colors">
                  Features
                </Link>
              </div>
              <div>
                <Link href="/#integrations" className="hover:text-[#2aa160] transition-colors">
                  Integrations
                </Link>
              </div>
              <div>
                <Link href="/#deploy" className="hover:text-[#2aa160] transition-colors">
                  Deployment
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="text-xs mt-2 space-y-1">
              <div>
                <Link href="/#demo" className="hover:text-[#2aa160] transition-colors">
                  Contact Sales
                </Link>
              </div>
              <div>
